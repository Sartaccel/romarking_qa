      ...
      <div className="table-container">
        <table className="comparative-table">
          ...
          <tbody>
            ...
            <tr>
              <td><b>Climate Adaptability</b></td>
              <td>✅ All-weather</td>
  ...
  <div className="takeaway-left">
    ...
    <ul className="takeaway-points">
      <li>
        ...
        eco-tourism, medical tourism, and disaster relief.
      </li>
      <li>
        🚚 <b>Container Housing</b> offers a <i>balance of durability and affordability</i>,
        but requires insulation and infrastructure retrofits.
      </li>
      <li>
        🧱 <b>Cement Structures</b> are best for <i>permanent, high-traffic installations</i>,
        but lack speed and flexibility.
      </li>
      <li>
        🪟 <b>Glass Domes</b> are niche — <i>aesthetic but fragile.</i>
      </li>
      <li>
        ⛺ <b>Igloos and Tent House</b> are <i>context-specific</i> and not scalable for
        modern, multi-climate use.
      </li>
    </ul>
  </div>
