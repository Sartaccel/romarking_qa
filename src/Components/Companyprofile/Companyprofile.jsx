...
const Companyprofile = () => {
  return (
      ...
      <section className="company-intro">
        <h1>Company Profile – <span>FRP Smart Living</span></h1>
        <p>
      ...
      <section className="vision-section">
        <div className="vision-text">
          ...
          <p>
            ...
            cleaner, and more responsible — a world built not just for today’s needs, but for generations to come.
          </p>
          ...
          <ul>
            ...
            <li><strong>Collaboration for Growth:</strong> We believe in partnerships — with developers, architects, investors, and local communities — to create lasting impact.</li>
          </ul>
        </div>
