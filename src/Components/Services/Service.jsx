    ...
    <div className="service-container">
      ...
      <div className="service-section animate-left">
        <div className="service-text">
          ...
          <ul>
            <li><strong> Food & Refreshments </strong></li>
            <li>Snacks & Drinks: Fast delivery of packaged snacks, beverages, and daily essentials to your DOME House.
            </li>
            <li><strong>Domestic help, Cleaning, and Concierge Services </strong></li>
            ...
            <li><strong>Easy access via mobile app or voice assistant </strong></li>
           <li>Control everything instantly through our app or simply speak it into action.
             Stay connected, get real-time updates, and experience convenience like never before.</li>
            <li><strong>Travel Made Easy with {" "}<a href="https://www.simplego.in/" target="blank" className="highlight">
                SimpleGo
              </a> </strong></li>
